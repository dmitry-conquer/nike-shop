<template>
  <section class="container mb-[14rem]">
    <h2 class="mb-32 lg:text-left text-2xl leading-tight sm:text-3xl text-center lg:text-4xl uppercase">
    ...
    <div>
      <div
        class="flex gap-20 pl-64 will-change-transform"
        id="cross-row">
        <div
          v-for="item in items"
          :key="item.name"
          class="relative  w-[250px] lg:w-[350px] shrink-0">
          <div
          ...
          <div class="flex items-start gap-8">
            <img
              :src="item.image"
              :alt="item.name"
              class="grow-1 h-[7rem] w-[11rem] lg:h-[9rem] lg:w-[15rem] -rotate-[24deg] object-contain" />
...
const items = [
  {
    ...
    price: "$271",
    image: "images/cross11.png",
  },
  {
    name: "NIKE Dunk High",
    price: "$187",
    image: "images/cross9.png",
  },
  {
    name: "Vans Old Skool Suede Honey Gold",
    price: "$219",
    image: "images/cross8.png",
  },
  {
    name: "Air Jordan 13 Retro Court Purple (Reflective)",
    price: "$178",
    image: "images/cross7.png",
  },
];
...
onMounted(() => {
  ...
  ScrollTrigger.matchMedia({
    "(min-width: 1024px)": min700px,
    // "(max-width: 1023px)": max699px,
  });
