<template>
  <section
    ...
    <img
      src="~/assets/images/converted/vector1.webp"
      alt="vector"
    ...
    <div
      ...
      <div
        ...
        <button
          ...
          class="absolute h-4 w-4 -translate-y-1/2 translate-x-1/2 rounded-full" :aria-label="s.name"></button>
      </div>
    </div>
    <div
      id="cross-selector"
      ref="cross"
      class="will-change-transform relative -left-8 top-1/2 z-20 w-[18rem] shrink-0 sm:left-0 sm:h-[60%] sm:w-[60%] md:h-[8rem] md:w-[24rem]  lg:h-[12rem] lg:w-[32rem] xl:h-[20rem] xl:w-[40rem]">
      <Transition
